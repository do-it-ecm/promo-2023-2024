...
J'ai choisi ce MON pour pouvoir approfondir et développer du front et back-end sur mon projet 3A, l'application [Killer]({{ site.url }}/projets/2023-2024/Killer/).
...
- MON précédents sur React.js de [Thomas Duroy]({{ site.url }}/promos/2022-2023/Duroy-Thomas/mon/MON_3.1/) et [Lucas Rioual]({{ site.url }}/promos/2023-2024/Rioual-Lucas/mon/temps-2.1/).
